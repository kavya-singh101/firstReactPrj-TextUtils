...
export default function TextForm(props) {
    ...
    return (
        ...
        <div className="container">
            ...
            <button className="btn btn-danger btn-outline-primary mx-2 text-dark" onClick={upClick}>Convert to uppercase</button>
            <button className="btn btn-danger btn-outline-primary mx-2 text-dark" onClick={lowClick}>Convert to lowercase</button>
            <button className="btn btn-danger btn-outline-primary mx-2 text-dark" onClick={copyTxt}>Copy Text</button>
            <button className="btn btn-danger btn-outline-primary mx-2 text-dark" onClick={clearTxt}>Clear Text</button>
            <button className="btn btn-danger btn-outline-primary mx-2 text-dark" onClick={removeSpaces}>Remove Extra spaces</button>
        </div>
